import { DoubleArrowOutlined, FormatListNumberedRounded, CalendarMonthOutlined, StickyNote2Outlined } from '@mui/icons-material';
import { SidebarItemType } from '../components/Sidebar/SidebarItem/SidebarItem';

export const sidebarItems: SidebarItemType[] = [
    { label: 'Upcoming', icon: DoubleArrowOutlined, path: '/upcoming' },
